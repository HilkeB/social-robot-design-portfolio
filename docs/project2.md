...
The user tries to plant flowers, which he has never done before. ROSE robot offers verbal instructions on how to plant these plants. i.e., “Dig a hole 5 cm wide,” “Place the pot in the hole,” “cover the pot with soil”...
Through this, ROSE provides simple, clear instructions on how to plant the plants properly. This will allow the user to feel satisfied with the result, since the plants will grow properly. Thus, a positive outcome is produced: The robot helps in teaching the user and gains more confidence.
...
![Exploration brainstorm methods](images/Storyboard.png)
/// caption
